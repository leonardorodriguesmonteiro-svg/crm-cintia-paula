...
export default async function Page({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main style={{ maxWidth: 820, margin: '40px auto', padding: 24, fontFamily: 'Arial, sans-serif', lineHeight: 1.6, color: '#111' }}>
      ...
      <p>A contratante deverá zelar pelos itens locados, responsabilizando-se por danos, perdas ou extravios.</p>

      <h2>7. Cancelamento e reagendamento</h2>
      <p>As condições seguirão as regras comerciais previamente acordadas entre as partes.</p>
