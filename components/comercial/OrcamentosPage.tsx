...
function corFormalizacao(status: string | null) {
  ...
  if (['CONTRATO_GERADO', 'CONTRATO_ENVIADO', 'AGUARDANDO_ASSINATURA'].includes(status || '')) return 'bg-purple-100 text-purple-800'
        ...
        <Card className="border-pink-200">
          <form onSubmit={salvar} className="space-y-6">
            <div>
              ...
              <p className="text-sm text-slate-500">Escolha a pré-reserva ou um cliente já cadastrado, defina o período e revise os itens da proposta.</p>
            </div>
              ...
              <div className="mt-4 rounded-2xl border border-pink-100 bg-pink-50/60 p-4">
                ...
                {!orcamento.contrato_id && orcamento.formalizacao_status === 'AGUARDANDO_DADOS' ? (
                  ...
                  <div className="mt-4 space-y-3">
                    ...
                    {orcamento.formalizacao_status === 'RESERVA_CONFIRMADA' && (
