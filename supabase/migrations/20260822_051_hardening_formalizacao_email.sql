-- Hardening da formalizacao comercial V2.
-- Mantem a RPC acessivel somente ao backend, remove dependencia de auth.role()
-- para Secret Keys modernas e exige e-mail valido antes de gerar o contrato.
...
begin
  ...
  -- As funcoes internas usam auth.uid() para auditoria do usuario do ERP.
  perform set_config(
    'request.jwt.claims',
