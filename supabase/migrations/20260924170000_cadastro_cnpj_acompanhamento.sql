-- Cadastro PJ no acompanhamento. Aplicar somente apos conferir constraints e backup de producao.
-- Nao altera CPF de clientes existentes nem remove indices.
begin;
